...
def main():
    ...
    """
    # open the video
    cap = cv2.VideoCapture(os.path.join(VIDEOS_ROOT, "000", "VIRB0401.MP4"))
    if not cap.isOpened():
...
def main_check():
    ...
    for filename in glob.glob(os.path.join(VIDEOS_ROOT, "*", "*")):
        print(filename)
...
if __name__ == "__main__":
    main_check_img(os.path.join(MSF_DATASET, "05.jpg"))
